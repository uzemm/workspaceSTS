...
CREATE TABLE BOOK_CLUB (
   ...
   , MEM_ID VARCHAR2(100) REFERENCES BOOK_MEMBER (MEM_ID) ON DELETE CASCADE
    , MEM_NAME VARCHAR2(100) NOT NULL
   , CLUB_INTRO   VARCHAR2(1000) NOT NULL
...
ALTER TABLE BOOK_CLUB_BOARD ADD CB_READ_CNT NUMBER DEFAULT 0;
ALTER TABLE BOOK_CLUB_APPLY ADD CLUB_NAME VARCHAR2(100);
...
ALTER TABLE BOOK_CLUB_BOARD ADD MEM_IMAGE VARCHAR2(200);
--북클럽게시판 댓글

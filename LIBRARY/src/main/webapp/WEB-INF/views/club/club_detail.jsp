		...
		<div class="col">
			<nav aria-label="Page navigation example">
				<ul class="pagination pagination-sm justify-content-center">
					<li class="page-item <c:if test="${!clubBoardPageVO.prev }">disabled</c:if>"><a class="page-link" href="/club/clubDetail?nowPage=${clubBoardPageVO.beginPage - 1 }"
						aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
					</a></li>
					<c:forEach begin="${clubBoardPageVO.beginPage }" end="${clubBoardPageVO.endPage }" var="pageIndex">
							<li class="page-item <c:if test="${clubBoardPageVO.nowPage eq pageIndex }">active</c:if>"><a class="page-link" href="">${pageIndex }</a></li>
						</c:forEach>
					<li class="page-item <c:if test="${!buySearchVO.next }">disabled</c:if>"><a class="page-link" href="/club/clubDetail?nowPage=${clubBoardPageVO.endPage + 1 }"

...
<!-- 알림창 Modal -->
<div class="modal" id="msgModal" aria-hidden="true" aria-labelledby="msgModalLabel" tabindex="-1">
...
<div class="modal fade" tabindex="-1" id="msgDetailModal">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-success btn-sm" data-bs-target="#msgModal" data-bs-toggle="modal">목록</button>
      </div>
    </div>
  </div>
</div>

...
public class MemberController {
   ...
   // 독서 플래너
	...
	public String bookPlaner(String memId, Model model) {
	...
	public String bookPlanerDetail(BookCommentVO bookCommentVO, Model model) {
		model.addAttribute("bookPlaner", memberService.selectBookPlanerDetail(bookCommentVO));
   ...
   public String insertBookPlaner(BookVO bookVO, BookCommentVO bookCommentVO, Model model, RedirectAttributes re) {
      memberService.insertBookPlaner(bookVO, bookCommentVO);
      re.addAttribute("memId", bookCommentVO.getMemId());
